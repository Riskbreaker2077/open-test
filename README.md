...
**[Descargar para Windows](https://github.com/Riskbreaker2077/open-test/releases/latest/download/OpenTest-Setup.exe)** · **[Ver la página del proyecto →](https://riskbreaker2077.github.io/open-test/)** · **[Guía para docentes](https://riskbreaker2077.github.io/open-test/guia.html)** · **[Roadmap](spec/constitution/roadmap.md)**
...
- **Distribución para Windows**: [instalador descargable](https://github.com/Riskbreaker2077/open-test/releases/latest/download/OpenTest-Setup.exe) con asistente, o ejecutable único portable — ver la [guía](https://riskbreaker2077.github.io/open-test/guia.html) o [`GUIA-DOCENTE.md`](GUIA-DOCENTE.md).
...
Para el día del examen en Windows no hace falta Node ni compilar nada: descargue **[`OpenTest-Setup.exe`](https://github.com/Riskbreaker2077/open-test/releases/latest/download/OpenTest-Setup.exe)** desde la [última versión](https://github.com/Riskbreaker2077/open-test/releases). También está en [`instalador/`](instalador/).

Para compilarlo usted mismo, desde Windows:
