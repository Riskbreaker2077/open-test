...
32. **031 · [Asistencia en la pantalla de proyección](../features/031-asistencia-en-proyeccion/spec.md)** — la proyección muestra, con nombre y apellido, quién falta por entrar y quién está conectado (marcando con ✓ a quien ya entregó), actualizado cada 5 s. Revisa por decisión del docente la regla "nada de nombres" de la 012 y de `mission.md`; notas, avance, preguntas y códigos siguen fuera del proyector. La API reutiliza `estadoDeSesion` y copia solo nombre, curso y entregado.
